package net.draconia.church.usherschedule.windows.day.panels.Details.listeners;
...
public class DayDetailsFieldBindingEditingChangeListener implements PropertyChangeListener, Serializable
{
	private static final long serialVersionUID = 67621882316294551L;
	
	private Map<String, JTextComponent> mMapFields;
	
	public DayDetailsFieldBindingEditingChangeListener()
	{ }
	
	public DayDetailsFieldBindingEditingChangeListener(final String sField, final JTextComponent txtField)
	{
		getFieldMap().put(sField, txtField);
	}
	
	public DayDetailsFieldBindingEditingChangeListener(final String[] sArrFields, final JTextComponent[] txtArrFields)
	{
